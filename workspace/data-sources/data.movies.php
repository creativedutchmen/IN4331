...
class datasourcemovies extends StaticXMLDatasource
{
    public $dsParamROOTELEMENT = 'movies';
    public $dsParamSTATIC = '<movie>
        <title handle=\"a-history-of-violence\">A History of Violence</title>
        <year>2005</year>
        <country>USA</country>
        <genre>Crime</genre>
    ...
    <movie>
        <title handle=\"unforgiven\">Unforgiven</title>
        <year>1992</year>
        <country>USA</country>
        <genre>Western</genre>
    ...
    <movie>
        <title handle=\"match-point\">Match Point</title>
        <year>2005</year>
        <country>USA</country>
        <genre>Crime</genre>
    ...
    <movie>
        <title handle=\"lost-in-translation\">Lost in Translation</title>
        <year>2003</year>
        <country>USA</country>
        <genre>Drama</genre>
        <director id=\"17\"/>
    ...
    <movie>
        <title handle=\"marie-antoinette\">Marie Antoinette</title>
        <year>2006</year>
        <country>USA</country>
        <genre>Drama</genre>
    ...
    <movie>
        <title handle=\"spider-man\">Spider-Man</title>
        <year>2002</year>
        <country>USA</country>
        <genre>Action</genre>
    ...
    public function about()
    {
        return array(
            ...
            'author' => array(
                'name' => 'Huib Keemink',
                'website' => 'http://in4331.huibkeemink.nl/getting_started',
                'email' => 'hkeemink@gmail.com'),
            'version' => 'Symphony 2.6.2',
            'release-date' => '2015-05-24T16:23:08+00:00'
        );
    }
